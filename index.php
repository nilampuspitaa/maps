...
<div class="container">
    <div class="row">
	<h2>Google Maps Coba</h2>
	<form method="post" action="">
	  <div class="row">
	            <div class="col col-lg-6">
	                Subjek
	                <input type="text" name="subjek" class="form-control" placeholder="ex : Ryan Pace"><br>
...
<?php 
        ...
        if(isset($_POST['submit']))
        {
            ...
            $sql = mysqli_query($koneksi, "INSERT INTO map SET
                                           subjek           = '$subjek',
                                           place_lat        = '$lat',
                                           place_lng        = '$lng',
...
<script>
      ...
      function initMap() {
        var map = new google.maps.Map(document.getElementById('map'), {
          center: {lat: -6.177149, lng: 106.822731},
          zoom: 11
